...
public class PedFamily extends PedPedigree {
	...
	public void add(TfamEntry tfamEntry) {
		if ((familyId != null) && (!familyId.equals(tfamEntry.getFamilyId()))) throw new RuntimeException("Cannot add member to family. Family IDs do not match: '" + familyId + "' vs '" + tfamEntry.getFamilyId() + "'");
